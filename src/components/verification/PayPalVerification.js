  ...
  onApprove = async (data, actions) => {
    return fetch("https://peaceful-lake-35455.herokuapp.com/getorder", {
      ...
      body: JSON.stringify({
        ...
        accEmail: this.props.verificationInfo.AccEmail,
        accPassword: this.props.verificationInfo.AccPassword,
        accLocation: this.props.verificationInfo.AccLocation,
        recoveryEmail: this.props.verificationInfo.AccRecoveryEmail,
      }),
    })
      .then(function (res) {
        if (!res.ok) {
